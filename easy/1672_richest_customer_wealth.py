...
"""
You are given an m x n integer grid accounts where accounts[i][j] is the amount of money the ith customer has in the ith. Return the wealth that the richest customer has.
